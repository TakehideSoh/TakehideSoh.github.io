...
#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="./soh.css"/>
...
#+NAME: problem
#+begin_quote
- この問題は [[http://people.brunel.ac.uk/~mastjjb/jeb/orlib/files/jobshop1.txt][Fisher and Thompson 6x6 instance (ft06)]] からの引用です.
